...
;(function($) {
  ...
  var methods = {
    init: function(settings) {
      ...
      if (this.opt.add && !methods.__execute.call(this, this.opt.add, item)) {
        return false;
      }
    ...
    }, __execute: function(callback, item) {
      ...
      if (this.opt.remove && !methods.__execute.call(this, this.opt.remove, item)) {
        return false;
      }
  ...
  $.fn.nestedy.defaults = {
    ...
    template     : undefined,
    typeful      : ['color', 'date', 'datetime', 'datetime-local', 'email', 'month', 'number', 'range', 'search', 'tel', 'text', 'textarea', 'time', 'url', 'week']
  };
